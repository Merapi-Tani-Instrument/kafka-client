...
func (r *MetadataResponse) partitionsFromTopic(topic string) ([]int32, error) {
	idx := slices.IndexFunc[[]*TopicMetadata, *TopicMetadata](r.Topics, func(tm *TopicMetadata) bool { return tm.Name == topic })
	if idx < 0 {
		return nil, ErrUnknownTopicOrPartition
	}

	var partitions []int32
	for _, p := range r.Topics[idx].Partitions {
